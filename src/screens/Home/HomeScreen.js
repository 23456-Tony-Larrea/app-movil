...
import { SafeAreaView, FlatList, View, Text, TextInput, Button, TouchableOpacity, ScrollView } from "react-native";
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: "#fff", flex: 1 }]}> 
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
          <View style={{ padding: 16, flex: 1 }}>
            ...
            {/* DateTimePicker para fecha de inicio */}
            {showStartDatePicker && (
              <DateTimePicker
            ...
            {/* DateTimePicker para fecha final */}
            {showEndDatePicker && (
              <DateTimePicker
